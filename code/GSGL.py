...
import tool as tl
from model import FLmodel,Loss,obj_func,Exc_obj_func,GSGL_obj_func
import svm
...
# w=torch.randn((num_class,len(Df_fs_id),fl_tim),dtype=torch.float64,requires_grad=True)
...
for i in range(10):
    ...
    for epoch in range(iterations):
        ...
        for param in flmodel.parameters():
            ...
            pant=GSGL_obj_func(param,grouplist,rol1=0.01,rol2=0.01,rol3=0.01)
            ll=l+pant
            w=param
        ll.backward()
        optimizer1.step()
